...
const C = {
  ...
  blue:     "#79AAF5",
  gold:     "#FFC110",
  green:    "#22C97A",   // ← verde para "Publicada"
  coffee:   "#764E31",
  cream:    "#FFF8EE",
  creamSub: "#D8CABC",
...
// ── Estado con color verde para "publicada" ──────────────────
const statusCfg: Record<string, { label: string; color: string }> = {
  publicada: { label: "Publicada", color: C.green   },   // ← VERDE
...
// ─────────────────────────────────────────────────────────────
// LOGO PROFESIONAL SVG (reemplaza el ícono morado genérico)
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// SIDEBAR — tipografía más grande, logo profesional
// ─────────────────────────────────────────────────────────────
function Sidebar({ active, setActive, userName, onLogout, navigate }: any) {
  return (
    <div style={{
      ...
      {/* Barra decorativa top — gradiente de paleta completa */}
      <div style={{
        height: 3,
        background: `linear-gradient(90deg, ${C.orange}, ${C.gold}, ${C.pink}, ${C.purple}, ${C.blue})`,
        flexShrink: 0,
      }} />
      ...
      <div style={{ padding: "22px 22px 18px", borderBottom: `1px solid ${C.borderBr}`, flexShrink: 0 }}>
        <div onClick={() => navigate("/")}
          ...
          <LogoMark size={40} />
          <div>
            <div style={{ fontSize: 16, fontWeight: 900, color: C.cream, lineHeight: 1.1, fontFamily: FD, letterSpacing: "-0.02em" }}>
              Nu-B Studio
            </div>
            <div style={{
              fontSize: 10, color: C.orange, marginTop: 4,
              letterSpacing: "0.18em", textTransform: "uppercase", fontFamily: FB, fontWeight: 700,
            }}>
              Panel Admin
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 11, color: C.orange, marginTop: 2, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: FB }}>
              Administrador
            </div>
          </div>
      ...
      {/* Nav — fuente más grande */}
      <div style={{ flex: 1, padding: "16px 12px", display: "flex", flexDirection: "column", gap: 3, overflowY: "auto" }}>
        <div style={{
          fontSize: 10.5, fontWeight: 800, color: C.creamMut,
          letterSpacing: "0.16em", textTransform: "uppercase",
          padding: "0 10px 12px", fontFamily: FB,
        }}>
          Navegación
        </div>
          ...
          return (
            <button key={id}
              ...
              style={{
                ...
                borderRadius: 12,
                padding: "12px 14px",          // más padding vertical
            ...
            >
              ...
              <span style={{
                fontSize: 14.5,              // ← FUENTE MÁS GRANDE
                fontWeight: on ? 700 : 500,
                color: on ? C.cream : C.creamSub,    // ← MEJOR CONTRASTE (antes era 45% opacidad)
      ...
      <div style={{ padding: "14px 12px 20px", borderTop: `1px solid ${C.borderBr}`, flexShrink: 0 }}>
        <div style={{ display: "flex", gap: 6 }}>
          <button style={{
            ...
            fontSize: 12.5, color: C.creamSub, fontWeight: 600, fontFamily: FB,
            transition: "all .15s",
          }}
          ...
          <button onClick={onLogout} style={{
            ...
            fontSize: 12.5, color: C.pink, fontWeight: 600, fontFamily: FB,
            transition: "all .15s",
          }}
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{
          ...
          background: `linear-gradient(135deg, ${C.orange}20, ${C.gold}10)`,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <div style={{
          ...
          borderRadius: 10, padding: "9px 16px", cursor: "text", transition: "border-color .15s",
        }}
        ...
        <button onClick={() => navigate("/admin/obras/crear")} style={{
          ...
          fontFamily: FB,
          boxShadow: `0 6px 22px ${C.orange}40`,
...
// ─────────────────────────────────────────────────────────────
// WELCOME BANNER — rediseñado, más atractivo
// ─────────────────────────────────────────────────────────────
function WelcomeBanner({ userName }: { userName: string }) {
  ...
  return (
    <div style={{
      ...
      padding: "28px 32px",
      background: `linear-gradient(135deg, rgba(255,132,14,0.12) 0%, rgba(204,78,161,0.08) 50%, rgba(141,76,205,0.10) 100%)`,
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", position: "relative" }}>
        <div>
          ...
          <div style={{
            ...
            background: "rgba(255,248,238,0.08)", border: `1px solid ${C.borderHi}`,
            fontSize: 11, fontWeight: 600, color: C.creamSub, fontFamily: FB,
          ...
          <h1 style={{
            ...
            lineHeight: 1.15, fontFamily: FD, color: C.cream,
          }}>
            {greeting},{" "}
            <span style={{
...
// ─────────────────────────────────────────────────────────────
// KPI CARDS — mejor contraste de texto
// ─────────────────────────────────────────────────────────────
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 18, position: "relative" }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${accent}28, ${accent2}15)`,
              border: `1px solid ${accent}38`,
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: `0 4px 14px ${accent}28`,
            }}>
          ...
          <div style={{
            fontSize: 40, fontWeight: 900, color: loading ? "rgba(255,232,200,0.15)" : C.cream,
            letterSpacing: "-1.5px", lineHeight: 1, marginBottom: 7,
            transition: "color .3s", position: "relative", fontFamily: FD,
          }}>
            {loading ? "—" : value}
          </div>
...
// ─────────────────────────────────────────────────────────────
// CHART SECTION — con botón para alternar tipo de gráfica
// ─────────────────────────────────────────────────────────────
    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: showChart ? 22 : 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ display: "flex", gap: 14, marginRight: 8 }}>
              {[{ c: C.orange, l: "Ventas" }, { c: C.blue, l: "Obras" }, { c: C.purple, l: "Artistas" }].map(({ c, l }) => (
                <span key={l} style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 12, color: C.creamSub, fontFamily: FB }}>
                  <span style={{ width: 18, height: 3, background: c, display: "inline-block", borderRadius: 2, boxShadow: `0 0 5px ${c}80` }} />
                  {l}
                </span>
              ))}
            </div>
          ...
          {showChart && (
            <div style={{
              display: "flex", gap: 2, background: "rgba(255,232,200,0.05)",
              ...
              {chartTypes.map(({ id, label, Icon }) => (
                <button key={id} onClick={() => setChartType(id)}
                  ...
                  style={{
                    ...
                    background: chartType === id ? `${C.orange}25` : "transparent",
                    cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
                    transition: "all .15s",
                    boxShadow: chartType === id ? `0 0 10px ${C.orange}30` : "none",
                  }}>
          ...
          {/* Toggle show/hide chart — botón solicitado */}
          <button onClick={() => setShowChart(v => !v)}
            style={{
              display: "flex", alignItems: "center", gap: 6,
              padding: "7px 14px", borderRadius: 9,
              background: showChart ? `${C.orange}18` : "rgba(255,232,200,0.05)",
              border: `1px solid ${showChart ? C.orange + "40" : C.border}`,
              color: showChart ? C.orange : C.creamMut,
            ...
            onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.borderColor = showChart ? `${C.orange}40` : C.border; el.style.color = showChart ? C.orange : C.creamMut; }}
          >
      ...
      {!showChart && (
        <div style={{
          ...
          {[
            { label: "Ventas", value: "78", color: C.orange },
            { label: "Obras",  value: "30", color: C.blue   },
            { label: "Artistas", value: "55", color: C.purple },
          ].map(({ label, value, color }) => (
            <div key={label} style={{
...
// ─────────────────────────────────────────────────────────────
// OBRAS RECIENTES — rediseñado, "publicada" en verde
// ─────────────────────────────────────────────────────────────
function ObrasRecientes({ obrasRecientes, loading, navigate }: any) {
  return (
    <div style={{
      background: C.card, border: `1px solid ${C.border}`,
      borderRadius: 18, padding: "24px",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 }}>
        ...
        <button onClick={() => navigate("/admin/obras")} style={{
          ...
          background: `${C.orange}15`, border: `1px solid ${C.orange}38`,
          borderRadius: 9, padding: "7px 13px",
          color: C.orange, fontSize: 12.5, fontWeight: 700,
          ...
          return (
            <div key={obra.id_obra}
              style={{
                ...
                borderBottom: i < obrasRecientes.length - 1 ? `1px solid rgba(255,232,200,0.05)` : "none",
            ...
            >
              ...
              <div style={{
                ...
                background: `${cfg.color}18`, overflow: "hidden",
                display: "flex", alignItems: "center", justifyContent: "center",
                border: `1px solid ${cfg.color}35`,
                boxShadow: `0 2px 10px ${cfg.color}18`,
              }}>
              ...
              {/* Badge — "publicada" en VERDE, mejorado */}
              <span style={{
                fontSize: 10.5, padding: "4px 11px", borderRadius: 20, fontWeight: 800,
                background: `${cfg.color}18`, color: cfg.color, flexShrink: 0,
                border: `1px solid ${cfg.color}38`,
                textTransform: "uppercase", letterSpacing: "0.07em", fontFamily: FB,
                boxShadow: cfg.color === C.green ? `0 0 8px ${C.green}30` : "none",
              }}>
                {cfg.label}
              </span>
            </div>
      ...
      {items.map(({ value, label, sub, accent, accent2, Icon }, i) => (
        <div key={label}
          style={{
            ...
            animation: `fadeUp .5s ease ${0.4 + i * 0.1}s both`,
          }}
        ...
        >
          ...
          <div style={{
            ...
            border: `1px solid ${accent}38`,
            display: "flex", alignItems: "center", justifyContent: "center",
            boxShadow: `0 6px 18px ${accent}28`,
          }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{
              fontSize: 34, fontWeight: 900, color: loading ? "rgba(255,232,200,0.15)" : C.cream,
              letterSpacing: "-1px", lineHeight: 1, marginBottom: 6, transition: "color .3s",
              fontFamily: FD,
            }}>
              {loading ? "—" : value}
            </div>
