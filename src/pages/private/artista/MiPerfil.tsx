...
function SeccionBancariaReadOnly({ artista }: { artista: ArtistaInfo }) {
  ...
  const masked = artista.clabe ? "•••• •••• •••• " + artista.clabe.slice(-4) : "—";
  return (
    <div className="mp-sec" style={{ animationDelay: "0.30s" }}>
      ...
      <div className="mp-fld-grid">
        <div>
          ...
          <div className="mp-input-ro" style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:8 }}>
            <span style={{ fontFamily:"monospace", letterSpacing:".06em", fontSize:13 }}>
              {artista.clabe ? (visible ? artista.clabe : masked) : "—"}
            </span>
            {artista.clabe && (
              <button
                type="button"
