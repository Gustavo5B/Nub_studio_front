        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 16 }} className="artista-dashboard-grid">
          ...
          <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 20, overflow: "hidden" }}>
            <div style={{ padding: "20px 24px 16px", borderBottom: `1px solid ${C.border}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => navigate("/artista/mis-obras")} style={{ display: "flex", alignItems: "center", gap: 4, background: "none", border: `1px solid ${C.border}`, borderRadius: 8, color: C.muted, fontSize: 12, fontWeight: 600, cursor: "pointer", padding: "6px 12px", fontFamily: "'DM Sans',sans-serif" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 20, padding: "20px" }}>
              ...
              <button onClick={() => navigate("/artista/perfil")}
                style={{ width: "100%", padding: "8px", borderRadius: 9, background: "rgba(255,255,255,0.04)", border: `1px solid ${C.border}`, color: C.muted, fontSize: 12, fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }}>
                Editar perfil
              </button>
            </div>
            ...
            {stats.rechazadas > 0 && (
              <div style={{ background: `${C.pink}10`, border: `1px solid ${C.pink}30`, borderRadius: 16, padding: "16px" }}>
                ...
                <button onClick={() => navigate("/artista/mis-obras")}
                  style={{ width: "100%", padding: "7px", borderRadius: 8, background: `${C.pink}20`, border: `1px solid ${C.pink}40`, color: C.pink, fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }}>
                  Revisar ahora
                </button>
              </div>
            )}
