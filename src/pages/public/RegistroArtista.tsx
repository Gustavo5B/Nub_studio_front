...
const C = {
  ...
  blue: "#2D6FBE", gold: "#A87006",
  bg: "#F9F8FC", surface: "rgba(0,0,0,0.02)",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      <Field label="Nombre completo" icon={<User size={15} />}>
        <input name="nombre_completo" value={form.nombre_completo} onChange={handle}
          ...
          style={{ ...inputStyle, borderColor: fieldErrors.nombre_completo ? C.warning : C.border }} />
        ...
        {form.contrasena && (
          <div style={{ display: "flex", gap: 4, marginTop: 6 }}>
            {[
              ...
              <div key={key} style={{ flex: 1, height: 3, borderRadius: 2, background: met ? C.orange : C.border, transition: "background .2s" }} />
            ))}
          </div>
        )}
      </Field>
    ...
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <Field label="Nombre artístico (opcional)" icon={<Sparkles size={15} />}>
        {(() => {
          ...
          else if (fieldErrors.nombre_artistico) borderColor = "#C4304A";
          return (
            <input
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: 12.5, color: C.muted, lineHeight: 1.6 }}>
                Ese nombre ya está registrado en Nu-B Studio. Por ahora escribe un <strong style={{ color: C.text }}>nombre provisional</strong> para completar tu solicitud.
      ...
      <Field label="Teléfono (opcional)" icon={<Phone size={15} />}>
        <input name="telefono" value={form.telefono} onChange={handle}
          ...
          style={{
            ...inputStyle,
            borderColor: fieldErrors.telefono ? "#C4304A" : C.border
          }} />
      ...
      <Field label="Biografía" icon={<FileText size={15} />}>
        <textarea name="biografia" value={form.biografia} onChange={handle}
          ...
          style={{
            ...
            resize: "vertical",
            minHeight: 100,
            borderColor: fieldErrors.biografia ? "#C4304A" : C.border
          }} />
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4 }}>
          {fieldErrors.biografia
            ? <span style={{ fontSize: 11.5, color: "#C4304A", fontWeight: 600 }}>⚠ {fieldErrors.biografia}</span>
            : <span />
          }
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Outfit',sans-serif", display: "flex", position: "relative", overflow: "hidden" }}>
      ...
      <div className="artista-banner" style={{ flex: 1, position: "relative", overflow: "hidden", background: "#0C0812", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 3, padding: "60px 52px" }}>
          ...
          <h1 style={{ fontSize: "clamp(28px,2.8vw,40px)", fontWeight: 900, color: "#FFFFFF", lineHeight: 1.15, margin: "0 0 14px", fontFamily: "'Outfit',sans-serif" }}>
            Forma parte de<br />
            <span style={{ background: `linear-gradient(135deg,${C.orange},${C.pink})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              nuestra galería
            </span>
          </h1>
          <p style={{ fontSize: 14.5, color: "rgba(255,255,255,0.65)", lineHeight: 1.75, margin: "0 0 36px", fontFamily: "'Outfit',sans-serif", maxWidth: 400 }}>
            Conectamos artistas de la <strong style={{ color: "rgba(255,255,255,0.90)" }}>Huasteca Hidalguense</strong> con coleccionistas de todo México.
          </p>
          ...
          {[
            ...
            <div key={title} style={{ borderLeft: `3px solid ${color}`, padding: "10px 16px", marginBottom: 12, background: "rgba(255,255,255,0.04)", borderRadius: "0 10px 10px 0" }}>
              <div style={{ fontSize: 13.5, fontWeight: 700, color: "#FFFFFF", marginBottom: 2, fontFamily: "'Outfit',sans-serif" }}>{title}</div>
              <div style={{ fontSize: 12.5, color: "rgba(255,255,255,0.65)", fontFamily: "'Outfit',sans-serif" }}>{desc}</div>
            </div>
          ))}
          ...
          <div style={{ marginTop: 28, background: "rgba(141,76,205,0.10)", border: "1px solid rgba(141,76,205,0.25)", borderRadius: 14, padding: "18px 20px" }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: C.purple, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 12, fontFamily: "'Outfit',sans-serif" }}>
            ...
            {[
              ...
              <div key={text} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", fontFamily: "'Outfit',sans-serif" }}>{text}</span>
              </div>
            ))}
            <div style={{ fontSize: 10.5, color: "rgba(255,255,255,0.30)", marginTop: 10, fontStyle: "italic", fontFamily: "'Outfit',sans-serif" }}>
          ...
          <div style={{ marginTop: 28, display: "flex", gap: 10, alignItems: "flex-end" }}>
            <div style={{ animation: "floatA 7s ease-in-out infinite" }}>
              <div style={{ borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,132,14,0.25)", boxShadow: "0 12px 32px rgba(0,0,0,0.5)", width: 100 }}>
                ...
                <div style={{ padding: "6px 10px", background: "rgba(14,11,26,0.9)" }}>
                  <span style={{ fontSize: 10.5, fontWeight: 700, color: "rgba(255,255,255,0.9)", fontFamily: "'Outfit',sans-serif" }}>Artesanía</span>
                </div>
              </div>
            </div>
            <div style={{ animation: "floatB 9s ease-in-out infinite" }}>
              <div style={{ borderRadius: 14, overflow: "hidden", border: "1px solid rgba(204,89,173,0.25)", boxShadow: "0 12px 32px rgba(0,0,0,0.5)", width: 88 }}>
                ...
                <div style={{ padding: "6px 10px", background: "rgba(14,11,26,0.9)" }}>
                  <span style={{ fontSize: 10.5, fontWeight: 700, color: "rgba(255,255,255,0.9)", fontFamily: "'Outfit',sans-serif" }}>Cerámica</span>
                </div>
              </div>
            </div>
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.65)", fontFamily: "'Outfit',sans-serif", paddingBottom: 8, paddingLeft: 4 }}>
      ...
      >
        <div style={{ width: "100%", maxWidth: 440 }}>
                ...
                <div key={label} style={{ display: "flex", alignItems: "flex-start", flex: i < PASOS.length - 1 ? 1 : "initial" }}>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                    <div style={{
                      ...
                      background: i <= paso ? `linear-gradient(135deg, ${C.orange}, ${C.pink})` : "rgba(0,0,0,0.04)",
                      border: `2px solid ${i <= paso ? "transparent" : "#E6E4EF"}`,
                    ...
                    <span style={{ fontSize: 11.5, fontWeight: 700, color: i <= paso ? C.orange : C.muted, fontFamily: "'Outfit',sans-serif", letterSpacing: "0.03em" }}>
                      {label}
                    </span>
                  </div>
                  {i < PASOS.length - 1 && (
                    <div style={{
                      ...
                      background: paso > i ? `linear-gradient(90deg, ${C.orange}, ${C.pink})` : "#E6E4EF",
                      margin: "16px 10px 0",
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: `linear-gradient(90deg, ${C.orange}, ${C.pink}, ${C.purple}, ${C.gold})`, borderRadius: "24px 24px 0 0" }} />
            ...
            {!terminado && (
              <>
                ...
                <p style={{ fontSize: 13, color: C.muted, margin: "0 0 24px", fontFamily: "'Outfit',sans-serif" }}>
          ...
          <p style={{ fontSize: 13, color: C.muted, textAlign: "center", marginTop: 20, fontFamily: "'Outfit',sans-serif" }}>
            ¿Ya tienes cuenta?{" "}
...
function Field({ label, icon, children }: { readonly label: string; readonly icon: React.ReactNode; readonly children: React.ReactNode }) {
  return (
    <div>
      <label style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, color: "#5A5870", marginBottom: 8, fontFamily: "'Outfit',sans-serif" }}>
        {icon} {label}
      </label>
      {children}
    </div>
...
const alertStyle = (isError: boolean): React.CSSProperties => ({
  ...
  fontSize: 13, color: isError ? "#A83B90" : "#0E8A50",
});
